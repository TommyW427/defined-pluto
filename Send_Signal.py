...
# ── Bit source file ─────────────────────────────────────────────
BIT_FILE = "bit_tests/bits_000.bin"
# ────────────────────────────────────────────────────────────────
...
class Send_Signal(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Load bits from file
        ##################################################
        bit_data = np.fromfile(BIT_FILE, dtype=np.uint8)
        print(f"Loaded {len(bit_data)} bits from {BIT_FILE}")
        self.tx_bits = list(bit_data)
        ...
        # Bit source from file (repeats forever)
