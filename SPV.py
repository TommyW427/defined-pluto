...
class SPV(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Single Pluto Validation", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Single Pluto Validation")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "SPV")
...
def main(top_block_cls=SPV, options=None):
